<?php
    ...
    if($_GET['search_key'] && !empty(trim($_GET['search_key']))){
        $search_key = mysqli_real_escape_string($db_conn, $_GET['search_key']);
    }
    else{
                    ...
                    <div class="card">
                        ...
                        <div class="card-body overflown-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group align-center">
                                                    ...
                                                    <a href="todo-operation.php?action=edit&edit_id=<?=$row['id'];?>&from=search&search_key=<?=$_GET['search_key'];?>" class="btn btn-sm btn-info">Edit</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-end">
                                                        ...
                                                        <a href="todo-operation.php?action=delete&delete_id=<?=$row['id'];?>&from=search&search_key=<?=$_GET['search_key'];?>" type="button" class="btn btn-danger">Yes</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <nav aria-label="d-block Page navigation">
                                <?php
                                $pagingUrl = "search.php?search_key=".$_GET['search_key']."&page=";
                                if($sort){
                                    $pagingUrl = "search.php?search_key=".$_GET['search_key']."&sort=".$_GET['sort']."&page=";
                                }
                                ?>
